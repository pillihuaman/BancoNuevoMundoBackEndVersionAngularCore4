...
namespace WU.Compras.Publicidad.PE.Wallet.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, DNI = model.DNI, LastName = model.LastName, FirstName = model.FirstName };
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult>  Register_login(string Email, string PasswordHash)
        {
            //ViewData["ReturnUrl"] = returnUrl;
